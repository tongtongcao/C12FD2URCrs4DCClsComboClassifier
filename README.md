The package is to train classifier to predict if a 4-DC-cluster + 2-uRWell-cross combo belongs to a track candidate by Multi-Layer Perceptron (MLP).\
...
For the estimator, inputs are average wires (divided by 112), slopes of 4 clusters, and x (divided by 140) & y (divided by 160) of uRWell crosses, as well as superlayers of missing clusters (divided by 6).
